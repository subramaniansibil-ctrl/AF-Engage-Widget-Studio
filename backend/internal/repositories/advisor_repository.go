...
func mockClients() []models.Client {
	return []models.Client{
		...
		client("client-005", "Noah Williams", 29, "noah.williams@example.com", models.RiskAggressive, models.RetirementStageAccumulation, 118000, 22000, 54000, 1450, 1050000, 67),
		client("client-006", "Priya Nair", 47, "priya.nair@example.com", models.RiskGrowth, models.RetirementStageAccumulation, 690000, 78000, 402000, 3600, 1750000, 63),
		client("client-007", "Lucas Bennett", 66, "lucas.bennett@example.com", models.RiskConservative, models.RetirementStageRetired, 1510000, 260000, 980000, 0, 1900000, 66),
		client("client-008", "Elena Garcia", 54, "elena.garcia@example.com", models.RiskModerate, models.RetirementStagePreRetirement, 910000, 102000, 590000, 3900, 1800000, 65),
		client("client-009", "Marcus Lee", 39, "marcus.lee@example.com", models.RiskAggressive, models.RetirementStageAccumulation, 420000, 51000, 238000, 2800, 1550000, 64),
		client("client-010", "Olivia Brooks", 63, "olivia.brooks@example.com", models.RiskConservative, models.RetirementStageRetired, 1220000, 190000, 820000, 0, 1700000, 63),
		client("client-011", "Theo Martin", 45, "theo.martin@example.com", models.RiskModerate, models.RetirementStageAccumulation, 760000, 84000, 455000, 3400, 1600000, 65),
		client("client-012", "Grace Kim", 51, "grace.kim@example.com", models.RiskGrowth, models.RetirementStageAccumulation, 980000, 118000, 620000, 4100, 2050000, 64),
		client("client-013", "Ethan Ross", 57, "ethan.ross@example.com", models.RiskModerate, models.RetirementStagePreRetirement, 1185000, 130000, 790000, 4400, 2200000, 65),
		client("client-014", "Sophia Ahmed", 33, "sophia.ahmed@example.com", models.RiskGrowth, models.RetirementStageAccumulation, 315000, 52000, 178000, 2300, 1350000, 66),
		client("client-015", "Daniel Murphy", 60, "daniel.murphy@example.com", models.RiskConservative, models.RetirementStagePreRetirement, 1430000, 170000, 955000, 3900, 2000000, 64),
		client("client-016", "Isabella Carter", 44, "isabella.carter@example.com", models.RiskModerate, models.RetirementStageAccumulation, 625000, 69000, 365000, 3100, 1500000, 65),
		client("client-017", "Benjamin Foster", 37, "benjamin.foster@example.com", models.RiskAggressive, models.RetirementStageAccumulation, 385000, 47000, 210000, 2600, 1450000, 67),
...
func client(id string, name string, age int, email string, risk models.RiskProfile, stage models.RetirementStage, total int64, savings int64, retirement int64, monthly int64, goal int64, targetAge int) models.Client {
